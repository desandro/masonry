...
;(function($){  
	...
	$.fn.masonry = function(options, callback) { 
		...
		return this.each(function() {  
			...
			if( !props.masoned ) {
				props.masonedID = masonedCount;
				masonedCount ++;
			} else {
				props.masonedID = wall.data('masonry').masonedID;
			}
			...
			var resizeNamespace = 'resize.masonry.' + props.masonedID;
			if ( !rszOn && opts.resizeable ) {
				$(window).bind(resizeNamespace, function() { masonryResize(wall, opts, props) } );
			}
			if ( rszOn && !opts.resizeable ) $(window).unbind(resizeNamespace); 
