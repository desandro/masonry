			...
			if ( !props.masoned && opts.fluid ) {
				$(window).bind('resize',function(){
					...
					if ( props.colCount != prevColCount )  {
						masonryArrange(wall, opts, props);
						debug(wall.attr('id'),'resize', 'MASONRY' , 'props.colCount:' + props.colCount + ', prevColCount:' + prevColCount  );
					} else {
						debug(wall.attr('id'),'resize', 'no masonry' , 'props.colCount:' + props.colCount + ', prevColCount:' + prevColCount  );
					}
